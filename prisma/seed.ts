...
async function main() {
  ...
  // สร้างผู้ใช้งาน
  const rootPassword = process.env.ROOT_PASSWORD || 'root4144128';
  ...
  console.log('   - Root:', root.username, '(Full system System — cannot be removed or edited)');
  ...
  console.log('');
  console.log('  👤 Root Account (Full system access):');
